...
class DashboardHandler(AuthBaseHandler):
    ...
    def get(self):
        self.render('templates-be/dashboard.html')
...
class DashboardStatusFragmentHandler(AuthBaseHandler):
    ...
    def get(self):
        ...
        self.render('templates-be/dashboard-status.html', teams=teams,
                questions=questions)

settings = dict(
    debug = True,
    static_path = os.path.join(os.path.dirname(__file__), 'static-be'),
